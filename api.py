...
def predict():
    ...
    # scaler = pickle.load(open(r"./Models/scaler.pkl", "rb"))
    # cv = pickle.load(open(r"./Models/countVectorizer.pkl", "rb"))
    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'Models/scaler.pkl'), 'rb') as file:
        scaler = pickle.load(file)

    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'Models/model_xgb.pkl'), 'rb') as file:
        predictor = pickle.load(file)

    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'Models/countVectorizer.pkl'), 'rb') as file:
        cv = pickle.load(file)
